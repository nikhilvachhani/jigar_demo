...
class LocationActivity : BaseActivity<BaseActivityBinding, LocationViewModel>(),
    LocationNavigator {
    ...
    private val viewModelInstance: LocationViewModel by viewModels {
        viewModeFactory
    }
    ...
    private fun setupNavController() {
        val graph: NavGraph =
            mNavController!!.navInflater.inflate(R.navigation.nav_location)
