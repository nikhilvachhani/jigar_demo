...
class FullScreenImageActivity : BaseActivity<BaseActivityBinding, FullScreenImageViewModel>(),
    FullScreenImageNavigator {
    ...
    private val viewModelInstance: FullScreenImageViewModel by viewModels {
        viewModeFactory
    }

    override fun getViewModel(): FullScreenImageViewModel {
    ...
    private fun setupNavController() {
        val graph: NavGraph =
            mNavController!!.navInflater.inflate(R.navigation.nav_full_screen_image)
