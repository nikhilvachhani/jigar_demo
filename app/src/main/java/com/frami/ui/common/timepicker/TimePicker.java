...
public class TimePicker extends FrameLayout {
    ...
    public TimePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        inflater.inflate(R.layout.custom_time_picker_widget,
    ...
    private void onTimeChanged() {
        String sHour = String.format("%02d", getCurrentHour());
        String sMin = String.format("%02d", getCurrentMinute());
        String sSec = String.format("%02d", getCurrentSeconds());
        tvTitle.setText(String.valueOf(sHour + ":" + sMin + ":" + sSec));
