package com.frami.ui.common.timepicker;
 ...
 */
public class TimePickerWithSecondsDialog extends AlertDialog implements OnClickListener,
...
//        requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        setButton(context.getText(R.string.select), this);
        setButton2(context.getText(R.string.cancel), (OnClickListener) null);
        //setIcon(android.R.drawable.ic_dialog_time);

        LayoutInflater inflater =
                (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.custom_time_picker_with_seconds_dialog, null);
        setView(view);
...
//        setTitle(mContext.getString(R.string.duration));// + " " + sHour + ":" + sMin + ":" + sSec);
    }
