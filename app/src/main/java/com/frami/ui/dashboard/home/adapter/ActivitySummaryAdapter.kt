...
class ActivitySummaryAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val binding: ListItemActivitySummaryBinding =
            DataBindingUtil.inflate(
                (layoutInflater)!!,
                R.layout.list_item_activity_summary,
                parent,
                false
            )
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemBinding.viewIsVisible = position != listData.lastIndex
    }
    ...
    inner class ViewHolder(var itemBinding: ListItemActivitySummaryBinding) :
