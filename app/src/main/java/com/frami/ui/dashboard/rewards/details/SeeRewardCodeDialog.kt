...
//        this.setContentView(view)
        this.bindingSheet = DataBindingUtil.inflate<DialogSeeRewardCodeBinding>(
            this.layoutInflater,
            R.layout.dialog_see_reward_code,
            null,
            false
        )
