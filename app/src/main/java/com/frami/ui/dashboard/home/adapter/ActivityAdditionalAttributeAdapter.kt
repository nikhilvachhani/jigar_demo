...
import com.frami.databinding.ListItemActivityAdditionalAttributesBinding

class ActivityAdditionalAttributeAdapter(
    private var listData: List<LabelValueData>,
    private val mListener: OnItemClickListener? = null
) : RecyclerView.Adapter<ActivityAdditionalAttributeAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val binding: ListItemActivityAdditionalAttributesBinding =
            DataBindingUtil.inflate(
                (layoutInflater)!!,
                R.layout.list_item_activity_additional_attributes,
                parent,
                false
            )
    ...
    inner class ViewHolder(var itemBinding: ListItemActivityAdditionalAttributesBinding) :
