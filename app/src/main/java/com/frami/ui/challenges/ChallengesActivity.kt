...
class ChallengesActivity : BaseActivity<BaseActivityBinding, ChallengesViewModel>(),
    ChallengesNavigator {
    ...
    private val viewModelInstance: ChallengesViewModel by viewModels {
        viewModeFactory
    }
    ...
    private fun setupNavController() {
        val graph: NavGraph =
            mNavController!!.navInflater.inflate(R.navigation.nav_challenges)
