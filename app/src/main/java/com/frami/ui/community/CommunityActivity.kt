...
class CommunityActivity : BaseActivity<BaseActivityBinding, CommunityViewModel>(),
    CommunityNavigator {
    ...
    private val viewModelInstance: CommunityViewModel by viewModels {
        viewModeFactory
    }
    ...
    private fun setupNavController() {
        val graph: NavGraph =
            mNavController!!.navInflater.inflate(R.navigation.nav_community)
