...
class ActivityActivity : BaseActivity<BaseActivityBinding, ActivityViewModel>(),
    ActivityNavigator {
    ...
    private val viewModelInstance: ActivityViewModel by viewModels {
        viewModeFactory
    }
    ...
    private fun setupNavController() {
        val graph: NavGraph =
            mNavController!!.navInflater.inflate(R.navigation.nav_activity)
