...
class EventsActivity : BaseActivity<BaseActivityBinding, EventsViewModel>(),
    EventsNavigator {
    ...
    private val viewModelInstance: EventsViewModel by viewModels {
        viewModeFactory
    }
    ...
    private fun setupNavController() {
        val graph: NavGraph =
            mNavController!!.navInflater.inflate(R.navigation.nav_events)
