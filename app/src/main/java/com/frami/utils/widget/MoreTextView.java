...
public class MoreTextView extends AppCompatTextView {
    ...
    public MoreTextView(Context context, AttributeSet attrs) {
        ...
        this.trimMode = typedArray.getInt(R.styleable.ReadMoreTextView_trimMode, TRIM_MODE_LENGTH);
        typedArray.recycle();
   ...
   /* public static void printEachForward(String source) {
    ...
    protected boolean isAdditionalText() {
        return text != null && text.length() > trimLength;
    }
    ...
    private CharSequence updateCollapsedText() {
        ...
        return new SpannableStringBuilder(text, 0, trimEndIndex)
                .append(ELLIPSIZE);
    }
